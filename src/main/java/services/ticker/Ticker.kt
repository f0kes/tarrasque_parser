...
class Ticker(runnerRegistry: RunnerRegistry) : ITicker, Runner(runnerRegistry) {
    ...
    private val time: Int
        get() {
            var time = 0
            val grp = entities!!.getByDtName("CDOTAGamerulesProxy") ?: return 0
            ...
            if (oldTime == null) {
                ...
                val timeTick = if (isPaused) grp.getEntityProperty<Int>("m_pGameRules.m_nPauseStartTick", null)!! else serverTick
